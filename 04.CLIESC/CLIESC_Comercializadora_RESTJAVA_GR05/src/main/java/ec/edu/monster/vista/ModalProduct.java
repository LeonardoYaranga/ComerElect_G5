...
public class ModalProduct extends javax.swing.JDialog {
    ...
    public ModalProduct(java.awt.Frame parent, boolean modal, String nombreProducto) {
        super(parent, modal);
        initComponents();

        setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
        setLocationRelativeTo(parent);
        setProductoNombre(nombreProducto);
        txt_cantidad.setText("1"); // Valor por defecto
    }
    ...
    public void setProductoNombre(String nombreProducto) {
        lblTitle1.setText("Agregar \"" + nombreProducto + "\" al Carrito");
    }
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(lblTitle1, javax.swing.GroupLayout.DEFAULT_SIZE,
        ...
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(txt_cantidad, javax.swing.GroupLayout.PREFERRED_SIZE, 41,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void btn_crearActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_crearActionPerformed
        if (txt_cantidad.getText().isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Por favor, ingrese la cantidad.", "Error",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalProduct.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
